...
#
# This file is derived from the file of the same path in tailscale/tailscale
# with the gocross-specific parts removed. The name is kept to signify where it comes from.
